  ...
  ?> -->
    ...
    <div class="column">
      ...
      if(isset($_POST['update'])){
          mysqli_query($conn,"UPDATE apdown SET ap_name = '".$_POST['ap_name']."',mac_address = '".$_POST['mac_address']."',serial_number = '".$_POST['serial_number']."', lokasi = '".$_POST['lokasi']."',status = '".$_POST['status']."'");
          header("location: http://localhost/run/wp-admin.php");
...
?>
          ...
          <div>
            <button type="submit" name="update" class="button-look">UPDATE</button> 
          </div>
          <br>
          <br>
    </form>
