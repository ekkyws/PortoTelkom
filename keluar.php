...
<body>
  ...
  <div>
      ...
      <hr>
        ...
        <h3>FORM INPUT AP KELUAR GUDANG</h3>
        <br>
        <h3>Navigation</h3>
    ...
    <div class="column">
      ...
      if(isset($_POST['submit'])){
        mysql_query("INSERT INTO gudang SET ap_name = '".$_POST['ap_name']."', mac_address = '".$_POST['mac_address']."', serial_number = '".$_POST['serial_number']."', lokasi = '".$_POST['lokasi']."',tanggal_keluar = '".$_POST['tanggal_keluar']."',status = '".$_POST['status']."',keterangan = '".$_POST['keterangan']."',kondisi = '".$_POST['kondisi']."'");}
      ?>
          ...
          <input type="text" placeholder="AP Name" name="ap_name" value="" required>
          ...
          <input type="date" placeholder="DD MM YYYY" name="tanggal_keluar" id="myFile"  value="">
